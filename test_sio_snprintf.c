...
int main(void) {
  {
    ...
    buffer4[2] = 'd';
    buffer4[3] = '\0'
    ssize_t ret = sio_snprintf(buffer, 1024, "%d%s%dokokokhi%%lol%d\n", 1000, "<hello>", -22333333, 0);
    sio_printf("%zd:%s", ret, buffer);
  ...
  {
    int ret = snprintf(buffer, 1024, "%d%s%dokokokhi%%lol%d\n", 1000, "<hello>", -22333333, 0);
    sio_printf("%d:%s", ret, buffer);
